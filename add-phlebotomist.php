...
$query="insert into pathologist(EmpID,FullName,MobileNumber) values('$empid','$fname','$mnumber')";
$result =mysqli_query($con, $query);
if ($result) {
echo '<script>alert("pathologist created successfully.")</script>';
...
<head>
    ...
    <title>Covid-19 Testing Management System | Add pathologiest</title>
