...
<form method="post">
  <div class="row">
                       ...
                       <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="regmobilenumber" name="regmobilenumber" placeholder="Please enter your registered mobile number" pattern="[0-9]" title="10 numeric characters only" required="true" maxlength="11">
                                        </div>
<div class="form-group">
...
<hr />
    ...
    $sql=mysqli_query($con,"select * from covidpatient where MobileNumber='$mnumber'");
