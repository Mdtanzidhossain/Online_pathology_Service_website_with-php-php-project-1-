...
$query="insert into covidpatient(FullName,MobileNumber,DateOfBirth,GovtissuedId,GovtissuedIdNo,FullAddress,Division) values('$fname','$mnumber','$dob','$govtid','$govtidnumber','$address','$state');";
$query.="insert into covidtestrecord(PatientMobileNumber,TestType,TestTimeSlot,OrderNumber) values('$mnumber','$testtype','$timeslot','$orderno');";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Covid-19 Test Registration</h1>
  ...
  <div class="row">
                        ...
                        <div class="form-group">
                            <label>Full Name</label>
                                  ...
                                  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Please enter your mobile number" pattern="[0-9]{11}" title="10 numeric characters only" required="true" onBlur="mobileAvailability()">
