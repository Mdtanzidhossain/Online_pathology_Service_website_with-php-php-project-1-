...
if (strlen($_SESSION['aid']==0)) {
  ...
  $email=$_POST['email'];
     ...
     $query=mysqli_query($con, "update covidadmin set AdminName='$aname', MobileNumber ='$mobno', Email= '$email' where ID='$adminid'");
    if ($query) {
...
<?php include_once('includes/sidebar.php');?>
  ...
  <div class="row">
                ...
                <?php
$adminid=$_SESSION['aid'];
$ret=mysqli_query($con,"select * from covidadmin where ID='$adminid'");
$cnt=1;
